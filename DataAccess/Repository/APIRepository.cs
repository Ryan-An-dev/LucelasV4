...
{
    public class APIRepository : IApiRepository, ICMDReceiver, IDisposable
    {
        ...
        public APIRepository(IContainerProvider Container)
        {
        ...
        public void Create(JObject msg)
        {
            ...
            {
                NetManager.Send(msg, COMMAND.CREATE_API_INFO);
            }
        }
        ...
        public void Get(JObject msg)
        {
            if (NetManager.session_id != 0)
            {
                NetManager.Send(msg, COMMAND.READ_API_INFO);
            }
        }
        ...
        public void Update(JObject msg)
        {
            if (NetManager.session_id != 0)
            {
                NetManager.Send(msg, COMMAND.UPDATE_API_INFO);
            }
        }
        ...
        public void Delete(JObject msg)
        {
            if (NetManager.session_id != 0)
            {
                NetManager.Send(msg, COMMAND.DELETE_API_INFO);
            }
        }
    }
}
