...
{
    public class PaymentCardAddPageViewModel : PrismCommonViewModelBase, IDialogAware
    {
        ...
        public PaymentCardAddPageViewModel(IDialogService _DialogService, IContainerProvider con) : base(_DialogService, con)
        {
